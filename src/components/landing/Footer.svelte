...
>
		...
		<div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
			...
			<div class="">
				...
				{#each FOOTER_LINKS as link}
					<p class="mb-4">
						<a href={link.href} class="text-neutral-600 dark:text-neutral-200">{link.name}</a>
					</p>
				{/each}
			</div>
			<!-- Contact section -->
	...
	<div class="bg-neutral-200 p-6 text-center dark:bg-neutral-700">
		...
		<a
			...
			href="https://tailwind-elements.com/">Köster Webservices</a
		>
	</div>
</footer>
